 ...
 */
class HeroSkillsTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.HeroSkillsTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setPhpName('HeroSkills');
		$this->setClassname('HeroSkills');
	...
	{
    $this->addRelation('Heroes', 'Heroes', RelationMap::MANY_TO_ONE, array('hero_id' => 'id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
