 ...
 */
class HeroesTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.HeroesTableMap';
	...
	public function initialize()
	{
	  // attributes
		$this->setName('heroes');
		$this->setPhpName('Heroes');
		$this->setClassname('Heroes');
	...
	{
    $this->addRelation('PrimaryAttributes', 'PrimaryAttributes', RelationMap::MANY_TO_ONE, array('primary_attribute_id' => 'id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('HeroTypes', 'HeroTypes', RelationMap::MANY_TO_ONE, array('type_id' => 'id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('HeroAffiliations', 'HeroAffiliations', RelationMap::MANY_TO_ONE, array('affiliation_id' => 'id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('HeroSkills', 'HeroSkills', RelationMap::ONE_TO_MANY, array('id' => 'hero_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
